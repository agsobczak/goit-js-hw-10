...
const debouncedSearch = (0, _lodash.debounce)((name)=>(0, _fetchCountries.loadCountries)(name), 300, {
    leading: true,
    trailing: false
});
...
function handleResults(results) {
    if (results.length > 10) (0, _notiflix.Notiflix).notify({
...
},{"lodash":"3qBDj","./fetchCountries":"fTQqv","notiflix":"5z0Oc"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
